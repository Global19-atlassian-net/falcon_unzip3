...
"""
In this version of ovlp_filter_with_phase we keep *only* the edges which
have both nodes of the same phase. Unphased edges are considered dangereous
here and removed.
"""
...
def parse_args(argv):
    ...
    parser.add_argument(
        '--max-diff', type=int, help="max difference of 5' and 3' coverage")
    parser.add_argument(
        '--max-cov', type=int, help="max coverage of 5' or 3' coverage")
    parser.add_argument(
        '--min-cov', type=int, help="min coverage of 5' or 3' coverage")
    parser.add_argument(
