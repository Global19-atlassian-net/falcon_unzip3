...
public class PlanSpec {
    ...
    public Plan plan() {
        final Plan plan = new Plan(new Project()
            ...
            "falcon_unzip3",
            new BambooKey("FALBS"))
           .description("Plan created from Bamboo Java Specs,  modify http://bitbucket.pacificbiosciences.com:7990/projects/SAT/repos/falcon_unzip3/browse project to update the plan.")
            ...
            .linkedRepositories("falcon_unzip3")
